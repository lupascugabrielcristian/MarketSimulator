...
function events(){
    return {
        ...
        rightMenuAddOptionEvent: "right_menu_add_option", // Primeste un argument de tipul {title: "string", callback: callBackFcRef}
        rightMenuRemoveOptionEvent: "right_menu_remove_option" // Primeste un argument de tipul "optionTitle"
    }
}
